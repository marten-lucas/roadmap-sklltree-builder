...
export const normalizeRelease = (raw) => {
  ...
  return {
    ...
    voiceOfCustomer: typeof raw.voiceOfCustomer === 'string' ? raw.voiceOfCustomer : '',
    fictionalCustomerName: typeof raw.fictionalCustomerName === 'string' ? raw.fictionalCustomerName : '',
