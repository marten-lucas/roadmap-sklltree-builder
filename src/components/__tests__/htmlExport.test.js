...
describe('htmlExport', () => {
  it('builds standalone html with a single roadmap page and embedded document payload', () => {
    ...
    expect(html).toContain('id="html-export-filter-toggle"')
    expect(html).toContain('data-html-export-release-filter="all"')
    expect(html).toContain('data-html-export-release-filter="now"')
    expect(html).toContain('data-html-export-scope-filter="__all__"')
    expect(html).toContain('html-export__menu-filter-label">Levels<')
    expect(html).toContain('html-export__menu-filter-label">Scopes<')
    expect(html).toContain('html-export__menu-filter-native')
    ...
    expect(html).toContain('syncFilterButtonState()')
    ...
    expect(html).toContain('const getLabelMode = (scale) => {')
    expect(html).toContain("if (scale < NODE_LABEL_ZOOM.farToMid) return 'far'")
    expect(html).toContain("if (scale >= NODE_LABEL_ZOOM.closeToVeryClose) return 'very-close'")
